...
This project provides a user interface to interact with an automated price tracking web scraper. Currently the tracker scrapes www.amazon.com, but could be configured to scrape multiple sources.
